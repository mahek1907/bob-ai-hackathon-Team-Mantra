    ...
    <header className="h-16 border-b border-slate-200 bg-white sticky top-0 z-30 px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-center gap-2 text-xs sm:text-sm">
          <span className="font-mono text-slate-400 uppercase tracking-wider font-semibold hidden sm:inline">
            Console
          </span>
          <ChevronRight className="w-3.5 h-3.5 text-slate-300 hidden sm:inline" />
          <span className="font-semibold text-slate-900 tracking-tight truncate max-w-[200px] sm:max-w-none">
            {getPageTitle()}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-right font-mono text-xs hidden md:block border-r border-slate-200 pr-3">
          <div className="text-slate-900 font-bold">{time}</div>
          <div className="text-[10px] text-slate-400">60.02 Hz • SCADA</div>
        </div>
        ...
        <div className="relative" ref={notifRef}>
          ...
          {isNotificationsOpen && (
            <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-xl border border-slate-200 shadow-xl z-50 p-4 space-y-3">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-2 w-60 bg-white rounded-xl border border-slate-200 shadow-xl z-50 p-3 space-y-2 text-xs">
              <div className="border-b border-slate-100 pb-2">
                <div className="font-bold text-slate-900">{currentUser?.name || 'Elena Vance'}</div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:opacity-50 rounded-lg shadow-xs transition-colors cursor-pointer shrink-0"
        >
