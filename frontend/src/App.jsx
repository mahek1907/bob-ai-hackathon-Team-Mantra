...
Human-in-the-Loop Mandate: Generated by IBM Granite 3.0 via IBM watsonx.ai. A certified utility grid operator must review and countersign before dispatch.`);
  ...
  return (
    <div className="flex h-screen bg-dark-900 text-slate-100 overflow-hidden font-sans relative">

      {/* Ambient animated grid backdrop for the whole console */}
      <div className="pointer-events-none fixed inset-0 grid-scan-bg opacity-40 z-0" />
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto bg-dark-900/60 relative z-10">
        ...
        <main key={activeTab} className="page-transition flex-1 p-4 sm:p-8 max-w-7xl w-full mx-auto space-y-6">
          {activeTab === 'overview' && (
            <OverviewPage
              summary={summary}
              assets={assets}
