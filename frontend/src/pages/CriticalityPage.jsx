    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-700/60 pb-4 animate-fade-in-up">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-mono font-bold px-2.5 py-1 rounded-md bg-indigo-500/15 text-indigo-400 border border-indigo-500/30">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div className="p-6 rounded-2xl border border-red-500/30 bg-red-500/10 shadow-panel">
          ...
          <div className="text-xl font-bold text-slate-100 mb-1">Regional Trauma Hospitals</div>
          <p className="text-xs text-slate-300 leading-relaxed font-medium">
            Emergency surgeries and life-support wards fed by Substation METRO-09 and NORTH-01 (+35 pts criticality weight).
          </p>
        </div>

        <div className="p-6 rounded-2xl border border-purple-500/30 bg-purple-500/10 shadow-panel">
          <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-xl font-bold text-slate-100 mb-1">Electrified Rail Transit</div>
          <p className="text-xs text-slate-300 leading-relaxed font-medium">
            Metropolitan subway and passenger rail line feeds carrying 85,000 riders/day (+25 pts criticality weight).
          </p>
        </div>

        <div className="p-6 rounded-2xl border border-cyan-500/30 bg-cyan-500/10 shadow-panel">
          <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-xl font-bold text-slate-100 mb-1">Municipal Water Treatment</div>
          <p className="text-xs text-slate-300 leading-relaxed font-medium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-slate-700/60 bg-dark-800 p-6 shadow-panel space-y-3">
            ...
            <p className="text-xs text-slate-300 leading-relaxed font-medium">
              Substation criticality is deterministically calculated in <code className="text-blue-400 font-mono font-semibold">src/criticality_engine.py</code>:
            </p>

            <div className="space-y-2 text-xs font-mono">
              <div className="flex justify-between p-2.5 rounded-lg bg-dark-900 border border-slate-800/60">
                <span className="text-slate-200 font-semibold">Hospital Connection</span>
                <span className="text-emerald-400 font-bold">+35 pts</span>
              </div>
              <div className="flex justify-between p-2.5 rounded-lg bg-dark-900 border border-slate-800/60">
                <span className="text-slate-200 font-semibold">Transit / Rail Network</span>
                <span className="text-emerald-400 font-bold">+25 pts</span>
              </div>
              <div className="flex justify-between p-2.5 rounded-lg bg-dark-900 border border-slate-800/60">
                <span className="text-slate-200 font-semibold">Water Plant Feed</span>
                <span className="text-emerald-400 font-bold">+20 pts</span>
              </div>
              <div className="flex justify-between p-2.5 rounded-lg bg-dark-900 border border-slate-800/60">
                <span className="text-slate-200 font-semibold">Population &gt; 50,000</span>
                <span className="text-emerald-400 font-bold">+20 pts</span>
              </div>
            </div>

            <div className="pt-2 text-xs text-slate-500 border-t border-slate-800/60 font-medium">
