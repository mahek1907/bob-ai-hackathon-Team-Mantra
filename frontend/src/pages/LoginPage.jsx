  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-dark-950 text-slate-100 font-sans">
      ...
      <div className="lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-dark-950 grid-scan-bg">
        <div className="w-full max-w-sm glass-panel rounded-2xl p-8 shadow-panel space-y-6 animate-fade-in-up">
          
          {/* Logo & Header */}
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 rounded-md bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white shadow-glow-blue">
                <Zap className="w-4 h-4" />
              </div>
              <span className="font-bold text-base text-slate-100">GridSentinel AI</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg border border-slate-600 bg-dark-800 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full px-3.5 pr-10 py-2.5 rounded-lg border border-slate-600 bg-dark-800 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all font-mono"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs text-slate-300">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded text-blue-400 border-slate-600 focus:ring-blue-500"
                />
                <span>Remember workstation</span>
              </label>
              <a href="#forgot" onClick={(e) => { e.preventDefault(); alert('Demo environment: click Sign In to continue.'); }} className="text-slate-500 hover:text-slate-200">
                Forgot password?
              </a>
            </div>
          ...
          <div className="p-3 rounded-lg bg-dark-900 border border-slate-700/60 text-xs space-y-1 font-mono">
            <div className="flex items-center justify-between text-slate-500 font-sans">
              <span className="font-semibold text-slate-200">Demo Access</span>
              <span className="text-[11px] text-emerald-400 font-bold">Auto-Loaded</span>
            </div>
            <div className="text-slate-300 truncate">User: <strong className="text-slate-100">dispatcher@gridsentinel.ai</strong></div>
            <div className="text-slate-300">Role: <strong className="text-slate-100">Lead Reliability Dispatcher</strong></div>
          </div>
